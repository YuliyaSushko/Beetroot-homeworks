...
// const answerNumber = +prompt('Введіть будь-яке число для знаходження всіх його дільників');
...
// const answerNumber = +prompt('Введіть п\'ятирозрядне число для перевірки чи являється воно паліндромом');
...
// };
// console.log(isPalindromeNumber(answerNumber));
...
// let answerNumber
// for (let i = 0; i < 10; i++) {
//   answerNumber = +prompt('Введіть' + (i + 1) + ' чисел: ')
